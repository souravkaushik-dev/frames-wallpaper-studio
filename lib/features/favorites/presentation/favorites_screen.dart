...
@override
State<FleckFavoritesScreen> createState() =>
_FleckFavoritesScreenState();
}

class _FleckFavoritesScreenState
extends State<FleckFavoritesScreen>
...
if (favoriteUrls.contains(wallpaper.url) &&
...
color: FleckTheme.primaryDark.withValues(
alpha: .10,
),
...
@override
State<_FavoriteWallpaperCard> createState() =>
_FavoriteWallpaperCardState();
}

class _FavoriteWallpaperCardState
extends State<_FavoriteWallpaperCard> {
bool _pressed = false;
...
Hero(
tag:
'wallpaper-preview-${wallpaper.url}',
child: Image.network(
wallpaper.url,
fit: BoxFit.cover,
...
@override
State<_FavoriteRemoveButton> createState() =>
_FavoriteRemoveButtonState();
}

class _FavoriteRemoveButtonState
extends State<_FavoriteRemoveButton> {
bool _pressed = false;
...
@override
State<_EmptyFavorites> createState() =>
_EmptyFavoritesState();
}

class _EmptyFavoritesState
extends State<_EmptyFavorites>
with SingleTickerProviderStateMixin {
...
@override
State<_FavoritesLoading> createState() =>
_FavoritesLoadingState();
}

class _FavoritesLoadingState
extends State<_FavoritesLoading>
with SingleTickerProviderStateMixin {
late final AnimationController _controller;
