...
textAlign: TextAlign.center,
style: GoogleFonts.manrope(color: _secondary, fontSize: 13.sp),
),
...
final liveX = math.sin(t) * 7.0;
final liveY = math.cos(t * 0.72) * 4.0;
final liveScale = 1.065 + math.sin(t * 0.82) * 0.018;

// Extra cinematic movement while swiping between pages.
final swipeX = pageOffset * 28.w;
final swipeRotate = pageOffset.clamp(-1.0, 1.0) * 0.012;
final swipeScale = 1.0 - distance * .018;
